#!/usr/bin/env python3
"""AMOS Bridge v2.4 - Phone Control HTTP Server (Whisper STT)
...
class BridgeHandler(BaseHTTPRequestHandler):
    ...
    def _handle_listen(self, body):
        ...
        Pipeline: termux-microphone-record -> base64 -> Whisper API -> text
        ...
        audio_file = "/tmp/ears.wav"
        
        # Step 1: Clean up previous recording
        self._run(f"rm -f {audio_file}")
        # Also kill any lingering recorder process

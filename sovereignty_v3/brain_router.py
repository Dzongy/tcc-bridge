...
class BrainRouter:
    ...
    def __init__(self):
        ...
        if not self.alive:
            print("[BRAINV WARNING: No GROQ_API_KEY — brain is offline. Set it in environment.")
    ...
    def think(self, prompt, context=None, max_tokens=1024):
        ...
        try:
            ...
            if resp.status_code != 200:
                ...
                print(f"[BRAINM Error: {self.last_error}")
            ...
            print(f"[BRAIN Response ({usage.get('total_tokens', '?')} tokens)"i)
            return answer

...
# ============================================================
# TCC Bridge v8.0.0 — ONE-TAP PERMANENT SETUP
...
echo "============================================================"
echo "  TCC BRIDGE v8.0.0 — PERMANENT INSTALLATION"
...
echo "[0/9] Requesting storage permission..."
...
# ════════════════════════════════════════════════
# STEP 4 — ecosystem_bulletproof.js for pm2
# ════════════════════════════════════════════════
echo "[4/9] Writing pm2 ecosystem config…"
cat > "$BRIDGE_DIR/ecosystem_bulletproof.js" << 'ECOEOF'
module.exports = {
  apps: [
    {
      name: "tcc-bridge",
...
ECOEOF
ok "ecosystem_bulletproof.js written."
...
pm2 start ecosystem_bulletproof.js && pm2 save
pm2 save
...
pkill -f 'python.*bridge_bulletproof.py' 2>/dev/null || true
sleep 1

# Start bridge via pm2
cd "$BRIDGE_DIR"
pm2 delete tcc-bridge 2>/dev/null || true
pm2 start ecosystem_bulletproof.js
pm2 save
